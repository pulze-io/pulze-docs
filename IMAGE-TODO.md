...
- [ ] `rf_service_mapped_drives.png` — Mapped Drives Settings — run as service context (`getting-started/run-as-a-service.md`)
...
- [ ] `rf_jobs_progress_bar.png` — Visual progress bar — colored segments for task states (`jobs/monitoring.md`)
- [ ] `rf_jobs_lifecycle_diagram.png` — Job lifecycle state diagram (`jobs/overview.md`)
- [ ] `rf_jobs_list_states.png` — Job list with multiple states — Pending, Working, Completed, Suspended (`jobs/overview.md`)
- [ ] `rf_jobs_detail_panel.png` — Job detail side panel — task list, controls, job properties (`jobs/tasks-and-details.md`)
- [ ] `rf_jobs_detached_windows.png` — Detached floating windows — two floating job detail windows side by side (`jobs/tasks-and-details.md`)
- [ ] `rf_jobs_vfb_preview.png` — Live VFB preview on hover — eye icon with frame buffer preview (`jobs/tasks-and-details.md`)
- [ ] `rf_jobs_asset_list.png` — Asset list in Submitter — file list, missing file markers, total size (`jobs/assets.md`)
- [ ] `rf_jobs_requirements_list.png` — Requirements list in Submitter — host app, engine, plugins (`jobs/requirements.md`)
...
### Statistics
- [ ] `rf_stats_node_utilization_timeline.png` — Node Utilization Timeline — render sessions per node over a date range (`statistics/overview.md`)
- [ ] `rf_stats_node_render_time_ranking.png` — Node Render Time ranking — bar chart ranking nodes by total render time (`statistics/overview.md`)
