...
Select the **V-Ray Standalone** template in the [Submitter](/renderflow/jobs/submitter) and browse for a .vrscene file. RenderFlow reads the file and populates the available properties: resolution, frame range, and render output.

<Frame caption="V-Ray Standalone submitter">
  <img src="/images/renderflow/rf_jobtypes_vray_standalone_submitter.png" alt="V-Ray Standalone submitter with resolution, frame, and output settings" />
</Frame>
