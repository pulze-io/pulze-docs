...
If you need remote rendering power without the network overhead, [RenderFlow Cloud](/renderflow/cloud-rendering/overview) is a better option. Assets are uploaded once, and rendering happens on high-speed cloud infrastructure.
...
For remote artists who don't have VPN access or who work with poor internet connections, [RenderFlow Cloud](/renderflow/cloud-rendering/overview) removes the dependency on shared storage entirely.
