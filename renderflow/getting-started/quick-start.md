...
<Frame caption="Server mode selection screen">
  <img src="/images/renderflow/rf_quickstart_mode_selection.png" alt="Server mode selection screen" />
</Frame>

<br/>

<Frame caption="Repository folder selection">
  <img src="/images/renderflow/rf_quickstart_repository_folder.png" alt="Repository folder selection" />
</Frame>
...
<Frame caption="Node connection via Discover">
  <img src="/images/renderflow/rf_quickstart_node_discover.png" alt="Node connection via Discover" />
</Frame>
...
<Frame caption="First job submitted and running">
  <img src="/images/renderflow/rf_quickstart_first_job_create.png" alt="First job submitted and running" />
</Frame>
...
- [Requirements](/renderflow/getting-started/requirements): hardware, network, and system requirements
- [Installation](/renderflow/getting-started/installation): detailed installation and configuration guide
- [Supported Apps](/renderflow/getting-started/supported-apps): full list of supported applications and render engines
- [Render Farm Basics](/renderflow/getting-started/render-farm-basics): new to render farms? Start here
