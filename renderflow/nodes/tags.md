...
Tags are labels you attach to nodes to categorize them beyond their pool assignment. They are useful for filtering the node table and for quickly selecting groups of nodes when whitelisting in the [Submitter](/renderflow/jobs/submitter).
...
<Frame caption="Batch tag editing for multiple selected nodes">
  <img src="/images/renderflow/rf_nodes_tag_editor.png" alt="Tag editor applied to multiple selected nodes" />
</Frame>
