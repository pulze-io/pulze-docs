...
<Frame caption="Appearance settings">
  <img src="/images/renderflow/rf_settings_appearance.png" alt="Appearance settings showing theme and auto-close options" />
</Frame>
...
<Frame caption="Users list with alias, group, role, and email columns">
  <img src="/images/renderflow/rf_settings_users.png" alt="Users table showing alias, group, role, and email columns" />
</Frame>
...
<Frame caption="Groups list with Add Group button">
  <img src="/images/renderflow/rf_settings_groups.png" alt="Groups list showing Admin and User default groups with Add Group button" />
</Frame>
...
<Frame caption="Policy matrix showing permissions per group">
  <img src="/images/renderflow/rf_settings_policies.png" alt="Policy table with groups as columns and features as rows" />
</Frame>

## Pools

Pools divide your farm into separate groups. Nodes only work on jobs submitted to their own pool, with no crossing. See [Nodes Overview](/renderflow/nodes/overview) for details on pool behavior and distribution modes.
...
<Frame caption="Pools list with node and job counts">
  <img src="/images/renderflow/rf_settings_pools.png" alt="Pools list showing pool names with node and job counts" />
</Frame>
...
<Frame caption="License table showing state, type, and assigned node">
  <img src="/images/renderflow/rf_settings_licenses.png" alt="License table showing state, type, activation date, expiration, and assigned node" />
</Frame>

## Repository

The repository is the shared network folder you configured during [server setup](/renderflow/getting-started/quick-start). It stores active and archived jobs, temporary artifacts (thumbnails, outputs), database backups, downloaded updates, and error reports.

You can view the current path, reset it, or browse for a new location. Every connected node must have access to this folder.

<Frame caption="Repository settings showing the current path">
...
API keys are required for authenticating with the [REST API](/renderflow/developers/authentication), SDKs, and CLI. Job creation is the only operation that does not require an API key.
...
<Frame caption="API Keys list with name and creation date">
  <img src="/images/renderflow/rf_settings_api_keys.png" alt="API Keys list showing key names, creation dates, and revoke buttons" />
</Frame>

## Integrations

Integrations connect third-party services to RenderFlow. Currently supported: Slack and Teams (for [job notifications](/renderflow/jobs/notifications)) and custom Webhooks (for triggering external services).
...
<Frame caption="Integrations list showing configured Slack and webhook entries">
  <img src="/images/renderflow/rf_settings_integrations.png" alt="Integrations list showing configured Slack, Teams, and webhook integrations" />
</Frame>
...
<Info>
Self-serve database restore is not yet available. If you need to restore from a backup, contact [support](/renderflow/support/contact-us).
</Info>

<Frame caption="Backup section showing manual backup button and backup file list">
  <img src="/images/renderflow/rf_settings_backup.png" alt="Backup section with manual backup button and list of existing backup files" />
</Frame>
