...
<Frame caption="Job monitoring table showing jobs in various states with real-time progress">
  <img src="/images/renderflow/rf_jobs_monitoring_table.png" alt="Job table with multiple jobs showing status, progress, and timing information" />
</Frame>
...
<Frame caption="Column customization panel">
  <img src="/images/renderflow/rf_jobs_column_customization.png" alt="Column settings showing available columns with drag handles for reordering" />
</Frame>
...
<Frame caption="Filtering and sorting controls in the Jobs table">
  <img src="/images/renderflow/rf_jobs_filtering.png" alt="Job table filter and sort controls" />
</Frame>
...
**Start / Stop** - control whether the job is active in the queue.
...
<Frame caption="Context menu with available job actions">
  <img src="/images/renderflow/rf_jobs_context_menu.png" alt="Right-click context menu showing Start, Stop, Reset, Edit, Quick Edit, Archive, Delete" />
</Frame>
