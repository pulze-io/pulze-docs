...
When you select a file in the [Submitter](/renderflow/jobs/submitter), RenderFlow scans the scene for all referenced assets and presents them in the Assets tab. This gives you a clear picture of what your scene depends on and whether anything is missing before the job reaches the farm.
