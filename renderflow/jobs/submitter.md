...
**Notifications** configures alerts for when the job completes. You can add multiple notifications per job across different channels: Email, Desktop, Slack, Teams, and Webhook. See [Notifications](/renderflow/jobs/notifications) for setup details.
