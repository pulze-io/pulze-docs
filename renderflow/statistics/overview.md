...
<Frame caption="The Statistics dashboards overview">
  <img src="/images/renderflow/rf_stats_overview.png" alt="RenderFlow Statistics overview showing the available dashboards and charts" />
</Frame>
...
A ranking of nodes by [benchmark](/renderflow/nodes/benchmark) score. Select the benchmark type (V-Ray CPU, Blender, Corona, Cinebench) to compare hardware performance across your farm.
