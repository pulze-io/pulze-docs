...
Install RenderFlow using the [silent installer](/products/renderflow/getting-started/silent-deploy) first. Service mode builds on top of the silent installation.
...
- [Silent Deploy](/products/renderflow/getting-started/silent-deploy): automated installation before setting up the service
- [Windows Network Setup](/products/renderflow/getting-started/windows-network-setup): UNC paths and shared storage configuration
