...
1. Review the [Requirements](/products/renderflow/getting-started/requirements) page to confirm your hardware, OS, and network are ready.
...
<Frame caption="Mode selection screen: Server / Node / Workstation">
  <img src="https://placehold.co/900x500?text=Mode+Selection+Screen+/+Node+/+Workstation" alt="Mode selection screen: Server / Node / Workstation" />
</Frame>
...
<Frame caption="Login with Browser button">
  <img src="https://placehold.co/900x500?text=Login+with+Browser+button" alt="Login with Browser button" />
</Frame>
...
<Frame caption="Server connection: IP entry and Discover button">
  <img src="https://placehold.co/900x500?text=Server+Connection+Screen" alt="Server connection: IP entry and Discover button" />
</Frame>
...
<Frame caption="Enabling node mode on a single workstation">
  <img src="https://placehold.co/900x500?text=Enabling+node+mode+on+a+single+workstation" alt="Enabling node mode on a single workstation" />
</Frame>
...
- Check that all [required ports](/products/renderflow/getting-started/requirements#ports) are open.
...
For persistent issues, see [Collecting Logs](/products/renderflow/support/collecting-logs) and [Contact Us](/products/renderflow/support/contact-us).
