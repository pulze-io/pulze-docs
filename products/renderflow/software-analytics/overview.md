...
<Frame caption="Software Analytics comparison table with base node selected">
  <img src="https://placehold.co/900x500?text=Software+Analytics+comparison+table" alt="Comparison table showing Match, Missing, Higher, and Lower states across nodes" />
</Frame>
