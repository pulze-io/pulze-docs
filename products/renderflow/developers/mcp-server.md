...
RenderFlow's MCP server works with [Claude Desktop](https://claude.ai/download), [ChatGPT Desktop](https://openai.com/chatgpt/desktop/), and many other MCP-compatible clients.
...
<Frame caption="Controlling RenderFlow through Claude Desktop using MCP">
  <img src="https://placehold.co/900x500?text=Claude+Desktop+MCP+Conversation" alt="Claude Desktop conversation with RenderFlow MCP" />
</Frame>
