...
<Info>
Generate an API key from **Settings → API Keys** in the RenderFlow UI. See the [Authentication](/products/renderflow/developers/authentication) page for details.
</Info>
...
The SDK maps directly to the [REST API](/products/renderflow/developers/rest-api) endpoints. Every method returns typed Pydantic models matching the API schemas.
