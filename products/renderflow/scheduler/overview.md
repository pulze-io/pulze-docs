...
<Frame caption="Scheduler calendar with events for overnight rendering and weekend restarts">
  <img src="https://placehold.co/900x500?text=Scheduler+weekly+calendar" alt="Weekly calendar showing color-coded events for node activation, suspension, and restarts" />
</Frame>
