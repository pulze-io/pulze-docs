...
Select the **Fusion** template in the [Submitter](/products/renderflow/jobs/submitter) and browse for a .comp file. RenderFlow reads the composition and lets you adjust frame settings, set the nth frame value, and add additional command-line arguments.
...
<Frame caption="Fusion job submitter">
  <img src="https://placehold.co/900x500?text=Fusion+Submitter" alt="Fusion job submitter with frame and command-line settings" />
</Frame>
