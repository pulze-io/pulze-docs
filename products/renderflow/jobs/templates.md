...
A system template defines which properties are available in the [Submitter](/products/renderflow/jobs/submitter) form. When you create a new job, you always start by picking a system template.
