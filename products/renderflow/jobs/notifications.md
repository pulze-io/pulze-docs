...
RenderFlow can send notifications when a job completes. You configure notifications per job in the [Submitter](/products/renderflow/jobs/submitter), and each job can have multiple notifications across different channels.
