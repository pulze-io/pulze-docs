...
Double-click a job row in the [Monitoring](/products/renderflow/jobs/monitoring) table, or click the **Open** button next to the job name. The detail panel slides in from the right as a side panel.
...
The detail panel also shows the full list of enabled [requirements](/products/renderflow/jobs/requirements) and any [notifications](/products/renderflow/jobs/notifications) configured for the job.
