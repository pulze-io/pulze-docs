...
The job table is designed for a quick overview of the farm's state. For detailed information about a specific job, including per-task progress, frame previews, render logs, and error details, open the job's detail panel. See [Tasks and Details](/products/renderflow/jobs/tasks-and-details).
